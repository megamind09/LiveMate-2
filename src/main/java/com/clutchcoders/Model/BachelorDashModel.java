...
public class BachelorDashModel {
     public static final String BachelorDash = null;


public BachelorDashModel() {
    }
  ...
  public String getName() { return name; }
    ...
    public List<String> getProfileImageUrl() { return photoUrls; }
    public List<String> getAmenities() { return amenities; }
    public List<String> getFeatures() { return features; }
    public List<String> getPreferences() { return preferences; }

    // Add setters or constructor if needed
